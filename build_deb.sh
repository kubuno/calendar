...
#   /usr/lib/kubuno/modules/calendar/{kubuno-calendar, module.toml, frontend/}
#   /usr/share/kubuno/modules/calendar/migrations/*.sql
#   /etc/kubuno/modules/calendar/config.toml.example
#
# Usage :
